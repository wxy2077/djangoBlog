...
!function (a, b) {
    ...
    !function () {
        ...
        b.prototype.init = function () {
            ...
            if (this.s.controls && this.$items.length > 1 && (d = '<div class="lg-actions"><button class="lg-prev lg-icon">' + this.s.prevHtml + '</button><button class="lg-next lg-icon">' + this.s.nextHtml + "</button></div>"), ".lg-sub-html" === this.s.appendSubHtmlTo && (f = '<div class="lg-sub-html"></div>'), b = '<div class="lg-outer ' + this.s.addClass + " " + this.s.startClass + '"><div class="lg" style="width:' + this.s.width + "; height:" + this.s.height + '"><div class="lg-inner">' + c + '</div><div class="lg-toolbar lg-group"><span class="lg-close lg-icon"><svg style="width: 25px; height: 25px" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="4081" width="200" height="200"><path d="M824.50370026 832.73057175a25.36526013 25.36526013 0 0 1-17.92971325-7.43554687L195.804636 214.52559662a25.3125 25.3125 0 1 1 35.85934925-35.85934925l610.82242013 610.82242011a25.417943 25.417943 0 0 1-17.98239613 43.24221325" fill="#434243" p-id="4082"></path><path d="M213.734581 832.73057175a25.3125 25.3125 0 0 1-17.92971326-43.29489614l610.82242013-610.76989173a25.36526013 25.36526013 0 0 1 35.80666637 35.85934925L231.66375351 825.29471588a25.3125 25.3125 0 0 1-17.92971325 7.43554688" fill="#434243" p-id="4083"></path></svg></span></div>' + d + f + "</div></div>", a("body").append(b), this.$outer = a(".lg-outer"), this.$slide = this.$outer.find(".lg-item"), this.s.useLeft ? (this.$outer.addClass("lg-use-left"), this.s.mode = "lg-slide") : this.$outer.addClass("lg-use-css3"), g.setTop(), a(window).on("resize.lg orientationchange.lg", function () {
                setTimeout(function () {
                    g.setTop()
                }, 100)
            ...
            }, this.s.backdropDuration), this.s.download && this.$outer.find(".lg-toolbar").append(''), this.prevScrollTop = a(window).scrollTop()
    ...
    !function () {
        ...
        c.prototype.init = function () {
            ...
            var b = this;
            a(this.core.s.appendAutoplayControlsTo).append(''), b.core.$outer.find(".lg-autoplay-button").on("click.lg", function () {
    ...
    !function () {
        ...
        c.prototype.init = function () {
            ...
            var a = this;
            a.core.s.toogleThumb && (a.core.$outer.addClass("lg-can-toggle"), a.$thumbOuter.append('<span class="lg-toogle-thumb lg-icon"><svg style="width: 25px; height: 25px" class="icon" viewBox="0 0 2048 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="4495" width="200" height="200"><path d="M1071.19194034 759.66841779l452.73106479-447.53960572A44.66445279 44.66445279 0 0 0 1486.1506626 243.47623678H580.77804058a44.75396036 44.75396036 0 0 0-37.8618506 68.65257529l452.64155722 447.53960572a44.75396036 44.75396036 0 0 0 75.63419314 0z" fill="#666666" fill-opacity=".65" p-id="4496"></path></svg></span>'), a.core.$outer.find(".lg-toogle-thumb").on("click.lg", function () {
